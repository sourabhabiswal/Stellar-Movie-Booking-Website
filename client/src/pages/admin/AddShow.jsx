...
function AddShow() {
    ...
    return nowplayingMovies.length > 0 ? (
            ...
            <div className="overflow-x-auto pb-4">
                <div className="flex gap-4 mt-4 w-max">
                    {nowplayingMovies.map((movie) => (
                        <div key={movie.id} onClick={() => setSelectedMovie(movie.id)} className="relative max-w-40 cursor-pointer hover:-translate-y-1 transition duration-300">
        ...
        {Object.keys(dateTimeSelection).length > 0 && (
            ...
            <button className="bg-primary text-white px-8 py-2 mt-6 rounded-lg hover:bg-primary/90 transition-all cursor-pointer">
                Add Show
            </button>
        </>
    ) : <Loading />
